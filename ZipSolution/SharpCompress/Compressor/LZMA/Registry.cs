...
using System.IO;
using System.Linq;
using SoMain.Common.SharpCompress.Common.SevenZip;
using SoMain.Common.SharpCompress.Compressor.BZip2;
using SoMain.Common.SharpCompress.Compressor.Filters;
using SoMain.Common.SharpCompress.Compressor.LZMA.Utilites;
using SoMain.Common.SharpCompress.Compressor.PPMd;

namespace SoMain.Common.SharpCompress.Compressor.LZMA
{
