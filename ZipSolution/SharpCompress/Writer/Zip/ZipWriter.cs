...
using SoMain.Common.SharpCompress.Common.Zip.Headers;
...
using SoMain.Common.SharpCompress.Compressor.LZMA;
using SoMain.Common.SharpCompress.Compressor.PPMd;
using SoMain.Common.SharpCompress.IO;
using DeflateStream = SoMain.Common.SharpCompress.Compressor.Deflate.DeflateStream;

namespace SoMain.Common.SharpCompress.Writer.Zip
{
