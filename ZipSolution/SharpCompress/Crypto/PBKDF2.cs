using System;
using SoMain.Common.BouncyCastle.Crypto;
using SoMain.Common.BouncyCastle.Crypto.Digests;
using SoMain.Common.BouncyCastle.Crypto.Macs;
using SoMain.Common.BouncyCastle.Crypto.Parameters;

namespace SoMain.Common.SharpCompress.Crypto
{
    //Gathered from:
